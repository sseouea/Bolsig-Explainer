...
class Finish(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.label = tk.Label(self, text="All files be downloaded", fg='white', bg='#383838')
        self.label.pack()

        self.button = tk.Button(self, text='Quit', background='white', fg='black', highlightbackground='#383838', command=self.quit)
...
class Error(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        #self.button1.pack(expand=True, fill="both", padx=10)
        ...
        #self.button2.pack(expand=True, fill="both", padx=10)
...
class OptionSelect(tk.Frame):
    def __init__(self, parent, manager, *args, **kwargs):
        ...
        self.select_button = tk.Button(self, text="Select (or 'All species')", font=12, highlightbackground='#F2F2F2', fg='black', command=self.generate)
...
class Program(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.label = tk.Label(self, text="ver 1.0", fg='white', background='#262626')
